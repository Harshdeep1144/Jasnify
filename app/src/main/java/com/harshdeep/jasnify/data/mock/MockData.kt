...
object MockData {
    ...
    fun getDetailsForVenue(venue: Venue): Venue {
        val detailImages = venue.images.toMutableList()
         // Ensure we have at least 8 unique gallery image placeholders
        ...
        return venue.copy(
            ...
            highlightItems = listOf(
                VenueHighlightItem(
                    ...
                    iconRes = "ic_user_default"
                ),
                VenueHighlightItem(
                    label = "Space Status",
                    value = "Indoor & Outdoor Available",
                    iconRes = "ic_star_2"
                ),
                VenueHighlightItem(
                    label = "Parking",
                    value = "Valet for 150+ Vehicles",
                    iconRes = "ic_car"
                ),
                VenueHighlightItem(
                    label = "Catering",
                    value = "In-house & Outside Allowed",
                    iconRes = "ic_food"
                ),
                VenueHighlightItem(
                    label = "Music",
                    value = "DJ & Sound System",
                    iconRes = "ic_music"
                )
            ),
                ...
                reviews = listOf(
                    ...
                    VenueReview(
                        ...
                        merchantReply = VenueMerchantReply(
                            ...
                            replyText = "Thank you Priya! We are glad you enjoyed your event. We look forward to hosting you again.",
    ...
    /**
     * Call this from a temporary setup screen or a one-time worker to upload mock data to Firestore.
     */
